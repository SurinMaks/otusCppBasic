...
namespace lambda {
	...
	bool int_compare(int v1, int v2) {
		return v1 < v2;
	}
	...
	void example_functor() {
		...
		bool result = comparator(42, 24);
		assert(result == (value1 < value2));

		bool result2 = IntComparator{}(42, 24);
	...
	void example_lambda() {
		...
		bool result = lambda(42, 24);
		assert(result == (value1 < value2));

		bool result2 = [](int v1, int v2) { return v1 < v2; }(42, 24);
		assert(result2 == (value1 < value2));
